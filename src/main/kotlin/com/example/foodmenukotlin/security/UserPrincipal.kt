...
class UserPrincipal(val id: UUID, val name: String, private val username: String, @field:JsonIgnore
val email: String, @field:JsonIgnore
    ...
    companion object {
        ...
        fun create(user: User): UserPrincipal {
            val authorities = user.roles.stream().map({ role -> SimpleGrantedAuthority(role.name?.name) }
